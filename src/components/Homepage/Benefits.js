...
export default function Benefits() {
  return (
    <div className={styles.benefits}>
      <h1>Benefits you get from using our site</h1>
      <div className={styles.benefitsContainer}>
        <div>
          ...
          <h2>Convenience</h2>
          <p>Access the Good Book anytime, anywhere</p>
        </div>
        <div>
          ...
          <p>Dive deep in the vast literature of the bible and find answers to the many question you may have</p>
        </div>
      </div>
    </div>
  );
